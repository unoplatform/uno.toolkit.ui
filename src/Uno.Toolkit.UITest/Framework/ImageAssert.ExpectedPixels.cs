...
namespace Uno.Toolkit.UITest.Framework
{
	public record struct ExpectedPixels
	{
		...
		public Color[,] Values { get; set; } = new Color[0, 0];

		public PixelTolerance Tolerance { get; set; } = PixelTolerance.None;

		public ExpectedPixels[]? Alternatives { get; set; } = Array.Empty<ExpectedPixels>();
