	...
	public static partial class Chip
	{
		public static partial class Resources
		{
			...
			public static partial class Chip
			{
				...
				public static ThemeResourceKey<double> ElevationDisabled => new("ChipElevationDisabled");
			...
			public static partial class ChipCheckGlyph
			{
			...
			public static partial class ChipIcon
			{
				public static partial class Foreground
				{
			...
			public static partial class ChipStateOverlay
			{
			...
			public static partial class ElevatedAssist
			{
				[ResourceKeyDefinition(typeof(Brush), "ElevatedChipBackground")]
				public static ThemeResourceKey<Brush> ElevatedChipBackground => new("ElevatedChipBackground");

				[ResourceKeyDefinition(typeof(double), "ChipElevation")]
				public static ThemeResourceKey<double> Elevation => new("ChipElevation");

				[ResourceKeyDefinition(typeof(Thickness), "ChipElevationBorderThickness")]
				public static ThemeResourceKey<Thickness> ElevationBorderThickness => new("ChipElevationBorderThickness");
			}

			public static partial class ElevatedFilter
			{
				[ResourceKeyDefinition(typeof(Brush), "ElevatedChipBackground")]
				public static ThemeResourceKey<Brush> ElevatedChipBackground => new("ElevatedChipBackground");
			...
			public static partial class ElevatedSuggestion
			{
				[ResourceKeyDefinition(typeof(Brush), "ElevatedChipBackground")]
				public static ThemeResourceKey<Brush> ElevatedChipBackground => new("ElevatedChipBackground");
			...
			public static partial class Suggestion
			{
				[ResourceKeyDefinition(typeof(Brush), "ChipBorderBrush")]
				public static ThemeResourceKey<Brush> BorderBrush => new("ChipBorderBrush");
			...
			[ResourceKeyDefinition(typeof(string), "MaterialCheckGlyphPathData")]
			public static StaticResourceKey<string> CheckGlyphPathData => new("MaterialCheckGlyphPathData");

			[ResourceKeyDefinition(typeof(Thickness), "ChipContentMargin")]
			public static ThemeResourceKey<Thickness> ChipContentMargin => new("ChipContentMargin");

			[ResourceKeyDefinition(typeof(Thickness), "ChipElevationMargin")]
			public static ThemeResourceKey<Thickness> ChipElevationMargin => new("ChipElevationMargin");

			[ResourceKeyDefinition(typeof(Brush), "ChipRippleFeedback")]
			public static ThemeResourceKey<Brush> ChipRippleFeedback => new("ChipRippleFeedback");
		}

		public static partial class Styles
		{
			[ResourceKeyDefinition(typeof(Style), "MaterialChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> Default => new("MaterialChipStyle");

			[ResourceKeyDefinition(typeof(Style), "MaterialAssistChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> Assist => new("MaterialAssistChipStyle");

			[ResourceKeyDefinition(typeof(Style), "MaterialElevatedAssistChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> ElevatedAssist => new("MaterialElevatedAssistChipStyle");

			[ResourceKeyDefinition(typeof(Style), "MaterialInputChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> Input => new("MaterialInputChipStyle");

			[ResourceKeyDefinition(typeof(Style), "MaterialFilterChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> Filter => new("MaterialFilterChipStyle");

			[ResourceKeyDefinition(typeof(Style), "MaterialElevatedFilterChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> ElevatedFilter => new("MaterialElevatedFilterChipStyle");

			[ResourceKeyDefinition(typeof(Style), "MaterialSuggestionChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> Suggestion => new("MaterialSuggestionChipStyle");

			[ResourceKeyDefinition(typeof(Style), "MaterialElevatedSuggestionChipStyle", TargetType = typeof(global::Uno.Toolkit.UI.Chip))]
			public static StaticResourceKey<Style> ElevatedSuggestion => new("MaterialElevatedSuggestionChipStyle");
		}
	}
}
