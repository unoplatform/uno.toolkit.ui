...
{
	[SamplePage(SampleCategory.Controls, nameof(ShadowContainer), Description = "Add many colored shadows to your controls.", SupportedDesigns = new[] { Design.Material, Design.Cupertino, Design.Agnostic })]
