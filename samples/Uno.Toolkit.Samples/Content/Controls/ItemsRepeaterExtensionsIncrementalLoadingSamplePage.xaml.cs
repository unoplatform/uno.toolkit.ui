...
[SamplePage(SampleCategory.Behaviors, "IR IncrementalLoading", SourceSdk.UnoToolkit, DataType = typeof(IncrementalLoadingViewModel), SupportedDesigns = new[] { Design.Material, Design.Cupertino, Design.Agnostic })]
