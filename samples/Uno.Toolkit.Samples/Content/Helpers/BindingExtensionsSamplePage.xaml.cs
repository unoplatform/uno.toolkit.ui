...
{
	[SamplePage(SampleCategory.Helpers, "Binding Extensions", SourceSdk.Uno, DataType = typeof(BindingExtensionsVM), IconPath = Icons.Helpers.MarkupExtension, SupportedDesigns = new[] { Design.Material, Design.Cupertino, Design.Agnostic })]
