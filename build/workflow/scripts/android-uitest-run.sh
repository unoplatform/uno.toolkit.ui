...
export UNO_UITEST_ANDROIDAPK_PATH=$UNO_UITEST_MOBILE_PROJECT_PATH/bin/Release/net8.0-android/android-x64/$SAMPLEAPP_NAME-Signed.apk
...
then
	...
	echo "y" | $LATEST_CMDLINE_TOOLS_PATH/bin/sdkmanager --sdk_root=${ANDROID_HOME} --install 'platforms;android-35' | tr '\r' '\n' | uniq
	...
	echo "y" | $LATEST_CMDLINE_TOOLS_PATH/bin/sdkmanager --sdk_root=${ANDROID_HOME} --install 'system-images;android-35;google_apis_playstore;x86_64' | tr '\r' '\n' | uniq
