...
dotnet publish /r /p:Configuration=Release /p:TargetFramework=net9.0-browserwasm /p:IsUiAutomationMappingEnabled=True /p:DisableMobileTargets=True /bl:$BASE_ARTIFACTS_PATH/wasm-uitest.binlog
